...
import com.apschulewitz.resdb.refdata.model.comparator.PersonDataComparator;
...
public class PersonServiceTest {
  ...
  private DataServiceTestRunner<PersonDto,
    Person,
    Long,
    PersonDataComparator,
    PersonTestHelper,
    PersonMapper,
    PersonDao,
    PersonService> testRunner;

  @Autowired
  private PersonTestHelper testHelper;

  @Autowired
  private PersonDataComparator testDataComparator;
