...
import com.apschulewitz.resdb.refdata.model.comparator.ImageTypeDataComparator;
...
public class ImageTypeServiceTest {
  ...
  private DataServiceTestRunner<ImageTypeDto,
    ImageType,
    Long,
    ImageTypeDataComparator,
    ImageTypeTestHelper,
    ImageTypeMapper,
    ImageTypeDao,
    ImageTypeService> testRunner;

  @Autowired
  private ImageTypeTestHelper testHelper;

  @Autowired
  private ImageTypeDataComparator testDataComparator;

  @Autowired
  private ImageTypeService service;
