...
public class MenuOwnerTypePersistenceConverter implements AttributeConverter<MenuOwnerType, String> {
     ...
     */
    public String convertToDatabaseColumn(MenuOwnerType entityValue) {
       return entityValue == null ? null : Objects.toString(entityValue.getCode(), null);
    }

    @Override
    public MenuOwnerType convertToEntityAttribute(String databaseValue) {
        return databaseValue == null ? null : MenuOwnerType.getTypeFor(databaseValue);
    }
}
