...
import com.apschulewitz.resdb.refdata.model.comparator.LanguageGroupDataComparator;
...
public class LanguageGroupServiceTest {
  ...
  private DataServiceTestRunner<LanguageGroupDto,
    LanguageGroup,
    Long,
    LanguageGroupDataComparator,
    LanguageGroupTestHelper,
    LanguageGroupMapper,
    LanguageGroupDao,
    LanguageGroupService> testRunner;

  @Autowired
  private LanguageGroupTestHelper testHelper;

  @Autowired
  private LanguageGroupDataComparator testDataComparator;

  @Autowired
  private LanguageGroupService service;
