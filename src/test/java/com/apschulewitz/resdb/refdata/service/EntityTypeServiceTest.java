...
import com.apschulewitz.resdb.refdata.model.comparator.EntityTypeDataComparator;
...
public class EntityTypeServiceTest {
  ...
  private DataServiceTestRunner<EntityTypeDto,
    EntityType,
    Long,
    EntityTypeDataComparator,
    EntityTypeTestHelper,
    EntityTypeMapper,
    EntityTypeDao,
    EntityTypeService> testRunner;

  @Autowired
  private EntityTypeTestHelper testHelper;

  @Autowired
  private EntityTypeDataComparator testDataComparator;
