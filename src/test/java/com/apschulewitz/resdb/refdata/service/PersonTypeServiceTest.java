...
public class PersonTypeServiceTest {
  ...
  private DataServiceTestRunner<PersonTypeDto,
    PersonType,
    Long,
    PersonTypeDataComparator,
    PersonTypeTestHelper,
    PersonTypeMapper,
    PersonTypeDao,
    PersonTypeService> testRunner;
  ...
  @Autowired
  private PersonTypeDataComparator testDataComparator;
  ...
  public void given_valid_dto_when_add_is_executed_then_return_saved_dto() {
    try {
      ...
      log.error("Exception corred in test", e);
    }
  }
