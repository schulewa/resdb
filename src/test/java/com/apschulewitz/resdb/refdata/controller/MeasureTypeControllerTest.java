...
public class MeasureTypeControllerTest {
  ...
  @MockBean
  private MeasureTypeDao mockedDao;
  ...
  public void beforeEachTest() {
    mockedDao.deleteAll();
    controller = new MeasureTypeController(mockedDao);
  }
  ...
  public void given_none_when_findAll_is_executed_then_return_list() {
    ...
    // When
    ResponseEntity<List<MeasureType>> responseEntity = controller.findAll();
  ...
  public void given_entity_when_save_is_executed_then_return_saved_entity() {
    ...
    // When
    ResponseEntity<MeasureType> responseEntity = controller.add(mockedRequest, unsaved);
  ...
  public void given_existing_entity_when_delete_is_executed_then_return_mark_entity_as_cancelled() {
    ...
    verify(mockedDao, times(1)).save(any(MeasureType.class));
