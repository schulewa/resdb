...
import com.apschulewitz.resdb.refdata.model.comparator.CalendarTypeDataComparator;
...
public class CalendarTypeServiceTest {
  ...
  private DataServiceTestRunner<CalendarTypeDto,
    CalendarType,
    Long,
    CalendarTypeDataComparator,
    CalendarTypeTestHelper,
    CalendarTypeMapper,
    CalendarTypeDao,
    CalendarTypeService> testRunner;
  ...
  @Autowired
  private CalendarTypeDataComparator testDataComparator;

  @Autowired
  private CalendarTypeService service;

  @Autowired
  private CalendarTypeDao dao;
